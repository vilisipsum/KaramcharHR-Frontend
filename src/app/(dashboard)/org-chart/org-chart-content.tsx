    ...
    <div className="flex flex-col items-center">
      ...
      {node.children && node.children.length > 0 && expanded && (
        <div className="flex items-start justify-center gap-6 mt-4 relative">
          ...
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-0.5 h-4 bg-white/10" />
              ...
              <div key={i} className="flex flex-col items-center relative">
                ...
                <div className="absolute top-0 w-full h-4">
                  ...
                  {node.children.length > 1 && (
                    <div className={`absolute top-0 h-0.5 bg-white/10 ${
    ...
    <div className="space-y-6">
      ...
      <div className="glass rounded-2xl p-8 overflow-x-auto">
        <div className="flex justify-center min-w-[600px] max-w-full">
          {orgChart.length === 0 ? (
            <div className="text-muted-foreground text-sm py-12">No active employees found to chart.</div>
          ) : (
            orgChart.map((node, i) => (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4">
        ...
        <div className="glass rounded-2xl p-5 flex items-center gap-4">
          ...
          <div>
            <div className="text-lg font-bold text-white">{stats.departmentsCount}</div>
        ...
        <div className="glass rounded-2xl p-5 flex items-center gap-4">
          ...
          <div>
            <div className="text-lg font-bold text-white">{stats.levelsCount}</div>
            <div className="text-xs text-white/40">Reporting Levels</div>
          </div>
        </div>
      </div>
    </div>
