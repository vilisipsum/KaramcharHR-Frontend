...
export function SuperAdminSidebar() {
  ...
  return (
    <aside className="h-full w-64 flex flex-col p-4 border-r border-slate-100 bg-[#0a0716]">
      {/* Logo */}
      <div className="mb-6 px-2">
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-xs font-extrabold text-slate-800 tracking-tight">KaramcharHR</p>
            ...
            <Link
              ...
              className={`flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold transition-all ${
                active
                  ...
                  : 'text-slate-500 hover:text-white hover:bg-slate-50 border border-slate-100 border border-transparent'
              }`}
            >
      ...
      <div className="border-t border-border/20 pt-3">
        <button
          onClick={() => signout()}
          className="flex items-center gap-3 px-3 py-2 rounded-xl text-sm font-semibold text-slate-500 hover:text-slate-800 hover:bg-slate-50 border border-slate-100 transition-all w-full cursor-pointer"
        >
